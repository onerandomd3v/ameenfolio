...
4. Provision Neon Auth, enable GitHub only, and configure its callback URL for local, preview, and production origins. Set a random cookie secret of at least 32 characters. Leave `ADMIN_GITHUB_USER_ID=`.
